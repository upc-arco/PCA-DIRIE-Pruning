...
def train_and_eval(
  ...
  with strategy_scope:
    ...
    if params.train.resume_checkpoint:
      initial_epoch = resume_from_checkpoint(model=model, model_dir=params.model_dir, train_steps=train_steps)
      if (initial_epoch == train_epochs):
        initial_epoch = 0
...
def eval(
  ...
  stats = common.build_stats(None, validation_output, None)
  return stats
